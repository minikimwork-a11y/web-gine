...
export default function SponsorshipPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8f9fa] text-[#2d2d2d] font-sans selection:bg-[#ff3c00] selection:text-white relative pb-24">
      ...
      <div className="absolute top-0 right-1/4 w-[600px] h-[600px] bg-[#ff3c00]/3 rounded-full blur-[150px] pointer-events-none" />
      <div className="absolute bottom-20 left-1/4 w-[600px] h-[600px] bg-[#ff3c00]/3 rounded-full blur-[150px] pointer-events-none" />
      ...
      <section className="max-w-4xl mx-auto px-6 pt-16 pb-8 text-center">
        <div className="max-w-3xl mx-auto space-y-4">
          ...
          <h1 className="text-4xl sm:text-5xl font-extrabold text-zinc-900 tracking-tight leading-none font-serif">
            따뜻한 나눔 신청
          </h1>
      ...
      <main className="max-w-3xl mx-auto px-6 py-6 relative z-10">
        <div className="bg-white border border-zinc-200/80 rounded-3xl p-8 shadow-2xl relative border-beam-active overflow-hidden">
          ...
          {step !== "success" && (
            <div className="flex justify-between items-center mb-10 max-w-md mx-auto relative select-none">
              <div className="absolute h-[2px] bg-zinc-200 left-4 right-4 top-1/2 -translate-y-1/2 z-0" />
              <div
                ...
                <div key={s} className="relative z-10 flex flex-col items-center gap-2">
                  ...
                  <span
                    className={`text-[10px] font-bold ${
                      step >= s ? "text-zinc-800" : "text-zinc-400"
                    }`}
                  >
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {step === 1 && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-2 gap-4">
                  {([
                    { id: "regular", label: "정기 후원", desc: "매달 약정 자동이체" },
                    ...
                    <div
                      ...
                      className={`border p-5 rounded-2xl cursor-pointer transition-all duration-300 flex flex-col justify-between h-32 select-none relative group ${
                        type === opt.id
                          ? "border-[#ff3c00] bg-[#ff3c00]/5 text-[#ff3c00]"
                    ...
                    >
                      ...
                      <div>
                        <strong className={`text-sm block font-bold transition-colors ${type === opt.id ? "text-[#ff3c00]" : "text-zinc-800 group-hover:text-[#ff3c00]"}`}>{opt.label}</strong>
                  ...
                  <div className="bg-zinc-50 border border-zinc-200/80 p-6 rounded-2xl space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <label htmlFor="reg-amount" className="text-xs font-mono text-zinc-500 block">
                        ...
                        <select
                          ...
                          className="w-full bg-white border border-zinc-200 rounded-lg px-4 py-2.5 text-xs text-zinc-800 outline-none focus:border-[#ff3c00]/60"
                        >
                      ...
                      <div className="space-y-2">
                        <label htmlFor="reg-pay-method" className="text-xs font-mono text-zinc-500 block">
                    ...
                    {amount === "custom" && (
                      <div className="space-y-2 animate-fadeIn">
                        <label htmlFor="reg-amount-custom" className="text-xs font-mono text-zinc-500 block">
                ...
                {type === "temporary" && (
                  <div className="bg-zinc-50 border border-zinc-200/80 p-6 rounded-2xl space-y-4">
                    <div className="space-y-2">
                      <label htmlFor="temp-amount" className="text-xs font-mono text-zinc-500 block">
                    ...
                    <div className="p-4 bg-zinc-100/60 border border-zinc-200/60 rounded-xl text-left space-y-1">
                      <strong className="text-xs text-zinc-800 block">NH농협은행: 301-0169-1431-71</strong>
                      <span className="text-[10px] text-zinc-500 block">예금주: 1004보금자리</span>
                      <span className="text-[10px] text-zinc-400 block">* 후원금을 위 계좌로 송금해주시면 실시간으로 기부금 영수증 처리가 완료됩니다.</span>
                    </div>
                  </div>
                )}
                ...
                {type === "goods" && (
                  <div className="bg-zinc-50 border border-zinc-200/80 p-6 rounded-2xl space-y-4">
                    <div className="space-y-2">
                      <label htmlFor="goods-desc" className="text-xs font-mono text-zinc-500 block">
                      ...
                      <textarea
                        ...
                        className="w-full bg-white border border-zinc-200 rounded-lg px-4 py-2.5 text-xs text-zinc-800 outline-none focus:border-[#ff3c00]/60 leading-relaxed"
                      />
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <label
                            ...
                            className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 px-4 py-2.5 rounded-lg text-xs font-mono cursor-pointer transition-colors block text-center text-zinc-700"
                          >
                      ...
                      <div className="space-y-2">
                        <label htmlFor="goods-val" className="text-xs font-mono text-zinc-500 block">
                          후원처리 희망 금액 (원, 선택사항)
                        </label>
                        <input
                          type="number"
                    ...
                    {goodsPhotoPreview && (
                      <div className="h-24 w-36 relative border border-zinc-200 rounded-lg overflow-hidden bg-zinc-100 animate-fadeIn">
                ...
                <div className="space-y-2">
                  <label htmlFor="amount-desc" className="text-xs font-mono text-zinc-500 block">
                    전하고 싶은 말씀 (선택사항)
                  </label>
                  <textarea
                    id="amount-desc"
            ...
            {step === 2 && (
              <div className="space-y-6 animate-fadeIn">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="space-y-2">
                    <label htmlFor="spons-name" className="text-xs font-mono text-zinc-500 block">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="spons-phone" className="text-xs font-mono text-zinc-500 block">
                  ...
                  <div className="space-y-2">
                    <label htmlFor="spons-fax" className="text-xs font-mono text-zinc-500 block">
                      팩스 번호
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="space-y-2">
                    <label htmlFor="spons-email" className="text-xs font-mono text-zinc-500 block">
                      이메일 주소
                    </label>
                    <input
                      type="email"
                ...
                <div className="space-y-2">
                  <label className="text-xs font-mono text-zinc-500 block">
                    우편물 주소 <span className="text-[10px] text-zinc-400">(기부금영수증 및 우편 수령 시 필요)</span>
                  </label>
                  <div className="flex gap-2">
                    <input
                      ...
                      value={zipcode}
                      readOnly
                      className="w-32 bg-zinc-100/50 border border-zinc-200 rounded-lg px-4 py-2.5 text-xs text-zinc-600 outline-none"
                    />
                    <button
                      type="button"
                      onClick={handleAddressSearch}
                      className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 px-4 py-2 rounded-lg text-xs font-mono cursor-pointer transition-colors text-zinc-700"
                    >
                      우편번호 검색
                    </button>
                  </div>
                  <input
                    ...
                    value={address}
                    readOnly
                    className="w-full bg-zinc-100/50 border border-zinc-200 rounded-lg px-4 py-2.5 text-xs text-zinc-600 outline-none"
                  />
                  <input
                    type="text"
                ...
                <div className="flex justify-between pt-4 border-t border-zinc-200">
                  <button
                    type="button"
                    onClick={prevStep}
                    className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-zinc-700 font-bold px-6 py-2.5 rounded-lg text-xs font-mono transition-colors cursor-pointer"
                  >
                    &larr; 이전 단계
                  </button>
                  <button
            ...
            {step === 3 && (
              <div className="space-y-6 animate-fadeIn">
                ...
                {type === "regular" && payMethod === "CMS" && (
                  <div className="bg-zinc-50 border border-zinc-200/80 p-6 rounded-2xl space-y-4">
                    <strong className="text-xs font-mono text-zinc-800 block border-b border-zinc-200/80 pb-2">
                      🏦 CMS 자동이체 은행 계좌 정보 등록
                    </strong>

                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <label htmlFor="cms-bank" className="text-xs font-mono text-zinc-500 block">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="cms-account" className="text-xs font-mono text-zinc-500 block">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="cms-holder" className="text-xs font-mono text-zinc-500 block">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="cms-birth" className="text-xs font-mono text-zinc-500 block">
                      ...
                      <div className="space-y-2">
                        <label htmlFor="cms-date" className="text-xs font-mono text-zinc-500 block">
                ...
                {type !== "volunteer" && (
                  <div className="bg-zinc-50 border border-zinc-200/80 p-6 rounded-2xl space-y-4">
                    ...
                    {receiptOpt !== "none" && (
                      <div className="space-y-2 animate-fadeIn">
                        <label htmlFor="spons-jumin" className="text-xs font-mono text-zinc-500 block">
                ...
                <div className="space-y-4">
                  <div className="bg-zinc-50 border border-zinc-200/80 rounded-xl p-4 space-y-2">
                    <strong className="text-xs text-zinc-800 block">■ 개인정보 수집 및 제3자 제공 동의 (필수)</strong>
                    <div className="text-[10px] text-zinc-500 leading-relaxed h-20 overflow-y-auto border border-zinc-200/60 p-2 bg-white rounded">
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      ...
                      <label htmlFor="agree-privacy" className="text-xs text-zinc-700 cursor-pointer select-none">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                  ...
                  <div className="space-y-2">
                    <div className="flex justify-between items-center">
                      <label className="text-xs font-mono text-zinc-700 font-bold block">
                        신청인(기부자) 서명 <span className="text-[#ff3c00]">*</span>
                      </label>
                      <button
                        type="button"
                        onClick={() => clearCanvas(donorCanvasRef, setShowDonorPlaceholder)}
                        className="text-[10px] font-mono text-zinc-400 hover:text-zinc-700 transition-colors cursor-pointer"
                      >
                        지우기 ✕
                      </button>
                    </div>

                    <div className="relative h-32 w-full border border-zinc-200 rounded-xl bg-zinc-50 overflow-hidden cursor-crosshair">
                      <canvas
                        id="donor-canvas"
                        ref={donorCanvasRef}
                        width={320}
                      ...
                      {showDonorPlaceholder && (
                        <div className="absolute inset-0 flex items-center justify-center text-[10px] text-zinc-300 select-none z-0 pointer-events-none">
                  ...
                  {type === "regular" && payMethod === "CMS" ? (
                    ...
                    <div className="h-32 border border-zinc-200 bg-zinc-50/50 rounded-xl flex items-center justify-center p-6 text-center text-[10px] text-zinc-400 leading-normal">
                      CMS 자동이체를 선택하시면 <br />
                ...
                <div className="bg-zinc-50 border border-zinc-200 p-4 rounded-xl flex flex-col sm:flex-row items-center gap-4 justify-between">
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-mono text-zinc-500">🤖 스팸방지 퀴즈:</span>
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      placeholder="정답 입력"
                      required
                      className="w-24 bg-white border border-zinc-200 rounded-lg px-3 py-1.5 text-xs text-center text-zinc-800 outline-none focus:border-[#ff3c00]/60 font-mono"
                    />
                    <button
                      type="button"
                      onClick={generateCaptcha}
                      className="text-xs text-zinc-400 hover:text-zinc-700 hover:bg-zinc-100 border border-zinc-200 px-2 py-1 rounded-lg cursor-pointer"
                      title="새 퀴즈"
                    >
                      ↻
                    </button>
                ...
                <div className="flex justify-between pt-4 border-t border-zinc-200">
                  <button
                    ...
                    onClick={prevStep}
                    disabled={submitting}
                    className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-zinc-700 font-bold px-6 py-2.5 rounded-lg text-xs font-mono transition-colors cursor-pointer disabled:opacity-40"
                  >
                    &larr; 이전 단계
                  </button>
                  <button
            ...
            {step === "success" && (
              <div className="text-center py-8 space-y-6 animate-fadeIn">
                ...
                <div className="space-y-2">
                  <h3 className="text-2xl font-extrabold text-zinc-900">따뜻한 동참에 감사드립니다!</h3>
                ...
                <div className="bg-zinc-50 border border-zinc-200 p-6 rounded-2xl text-left text-xs space-y-3 max-w-md mx-auto shadow-sm">
                  <h4 className="font-bold border-b border-zinc-200/80 pb-2 text-zinc-800 font-serif text-sm">신청 세부 사항 요약</h4>
                  <div className="grid grid-cols-3 gap-y-2 font-mono text-[11px] text-zinc-500">
                    <div>후원 유형:</div>
                    <div className="col-span-2 text-zinc-800 font-sans font-bold">{getTypeName(type)}</div>
                    ...
                    {type === "regular" && (
                      <>
                        ...
                        <div>납부 방식:</div>
                        <div className="col-span-2 text-zinc-800">{payMethod === "CMS" ? "CMS 자동이체 계좌 등록" : "직접 송금"}</div>
                      </>
                    )}
                    ...
                    {type === "temporary" && (
                      <>
                        ...
                        <div>납부 방식:</div>
                        <div className="col-span-2 text-zinc-800">직접 계좌이체송금</div>
                      </>
                    )}
                    ...
                    {type === "goods" && (
                      <>
                        <div>물품 정보:</div>
                        <div className="col-span-2 text-zinc-800 font-sans">{goodsDesc}</div>
                      </>
                    )}

                    <div>신청인명:</div>
                    <div className="col-span-2 text-zinc-800 font-sans font-bold">{name}님</div>

                    <div>연락처:</div>
                    <div className="col-span-2 text-zinc-800">{phone}</div>
                  </div>
                </div>
                ...
                <div className="flex justify-center gap-4 pt-4">
                  <button
                    ...
                    className="bg-zinc-100 hover:bg-zinc-200 border border-zinc-200 text-zinc-700 font-bold px-6 py-2.5 rounded-lg text-xs font-mono transition-all cursor-pointer"
                  >
                    추가 후원하기
                  </button>
                  <a
